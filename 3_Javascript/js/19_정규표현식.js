...
document.getElementById("btn2").addEventListener("click", () => {
    ...
    // [abcd] : 문자열 내에 a, b, c, d 중에 하나라도 일치하는 문자가 있는지 검사
    const regExp2 = /[abcd]/;
    ...
    div1.innerHTML += "/[group]/, 100group : " + regEx3.test("100group") + "<hr>"; // flase

    // $(달러) : 문자열의 끝을 의미
    // 문자열의 끝이 group인지 확인
    const regExp4 = /group$/;
    div1.innerHTML += "/[group]/, group100 : " + regExp4.test("group100") + "<hr>"; // flase
...
document.querySelector("#inputName").addEventListener("keyup", (e) => {
    ...
    if(regExp.test(e.target.value)) {
        ...
        // 유효하지 않은  경우
        span.innerText = "유효한 형식이 유효하지 않습니다."; 
